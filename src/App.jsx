      ...
      <ErrorBoundary>
        ...
        >
          ...
          >
            ...
            {/* Unified Hero Dashboard - Search + Filters + Graph */}
            <HeroDashboard
            ...
            {/* Flight Results Section with Staggered Animation */}
            {!loading && hasResults && (
              <Box
                sx={{
                  mt: { xs: 4, sm: 6, md: 8 },
              ...
              >
                ...
                {/* Flight Cards with Staggered Fade-In Animation */}
